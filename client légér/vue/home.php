...
?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-icon"><img src="images/icons/client_128.png" alt="Clients" style="width:48px;height:48px;object-fit:contain"></div>
            <div class="stat-info">
        ...
        <div class="stat-card accent">
            <div class="stat-icon"><img src="images/icons/gite_128.png" alt="Gîtes" style="width:48px;height:48px;object-fit:contain"></div>
            <div class="stat-info">
        ...
        <div class="stat-card success">
            <div class="stat-icon"><img src="images/icons/reservation_128.png" alt="Réservations" style="width:48px;height:48px;object-fit:contain"></div>
            <div class="stat-info">
        ...
        <div class="stat-card danger">
            <div class="stat-icon"><img src="images/icons/dashboard_128.png" alt="CA" style="width:48px;height:48px;object-fit:contain"></div>
            <div class="stat-info">
        ...
        <div class="card-body">
            <div class="menu-grid">
                <a href="index.php?page=gestion_gite" class="menu-item">
                    <img src="images/icons/gite_128.png" alt="Gîtes">
                    Gérer les Gîtes
                </a>
                <a href="index.php?page=gestion_reservation" class="menu-item">
                    <img src="images/icons/reservation_128.png" alt="Réservations">
                    Gérer les Réservations
                </a>
                <?php if ($estProprio): ?>
                <a href="index.php?page=gestion_client" class="menu-item admin-only">
                    <img src="images/icons/client_128.png" alt="Clients">
                    Gérer les Clients
                </a>
                <a href="index.php?page=gestion_proprio" class="menu-item admin-only">
                    <img src="images/icons/proprio_128.png" alt="Propriétaires">
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:0">
            <div class="table-wrapper" style="border:none;border-radius:0;box-shadow:none">
                <table>
                    <thead>
                        <tr><th>#</th><th>Client</th><th>Gîte</th><th>Dates</th><th>Prix</th><th>Statut</th></tr>
                    </thead>
                    <tbody>
                        <?php foreach ($stats['recentes'] as $r):
                            $today = (new DateTime())->format('Y-m-d');
                            if ($r['statut_r'] === 'à valider')          { $badge = 'badge-avalider'; $label = 'À valider'; }
                            elseif ($r['datefin'] < $today)              { $badge = 'badge-termine';  $label = 'Terminée'; }
                            elseif ($r['datedebut'] <= $today)           { $badge = 'badge-encours';  $label = 'En cours'; }
                            else                                         { $badge = 'badge-planifie'; $label = 'Planifiée'; }
                        ?>
                        <tr>
