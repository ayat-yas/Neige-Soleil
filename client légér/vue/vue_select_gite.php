...
?>
    ...
    <div class="action-bar">
        ...
        <?php endif; ?>
        <span style="margin-left:auto;color:var(--c-muted);font-size:.85rem"><?php echo count($gites); ?> gîte(s)</span>
    </div>
    ...
    <div class="table-wrapper">
        <table>
            <thead>
                <tr>
                    <th>#</th><th>Adresse</th><th>Surface</th><th>Pièces</th><th>Loyer / jour</th><th>Proprio #</th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php if (empty($gites)): ?>
                    <tr><td colspan="7">
                        <div class="empty-state"><div class="empty-icon">🏠</div><p>Aucun gîte enregistré.</p></div>
                    </td></tr>
                <?php else: foreach ($gites as $g): ?>
                    <tr>
                        ...
                        <td class="table-actions">
                            <?php if ($estProprio): ?>
                                <a href="index.php?page=vue_insert_gite&id=<?php echo $g['idgite']; ?>" class="btn btn-warning btn-sm">✏</a>
                                <form method="POST" action="index.php?page=gestion_gite" style="display:inline">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-sm"
                                            onclick="return confirm('Supprimer ce gîte et ses réservations ?')">🗑</button>
                                </form>
                            <?php else: ?>
